	...
	return (
		<>
			...
			<div className='text-box max-w-xl'>
				...
				<h3 className='title-sm text-lg font-medium'>Definitions</h3>
				<p className='box-text'>For the purposes of this Privacy Policy:</p>
				<ul>
					<li className='mb-2'>
						<p className='box-text'>
					...
					<li className='mb-2'>
						<p className='box-text'>
							<span className='font-medium'>Country</span> refers to: Australia
						</p>
					</li>
					<li className='mb-2'>
						<p className='box-text'>
					...
					<li className='mb-2'>
						<p className='box-text'>
							...
							apexapps.com.au, accessible from https://www.apexapps.com.au
						</p>
					</li>
					<li className='mb-2'>
						<p className='box-text'>
			...
			<div className='text-box max-w-xl'>
				...
				<h3 className='title-sm text-lg font-medium'>Personal Data</h3>
				<p className='box-text'>
				...
				<ul className='w-full'>
					<li className='mb-2'>
						<p className='box-text'>Email address</p>
					</li>
					<li className='mb-2'>
						<p className='box-text'>First name and last name</p>
					</li>
					<li className='mb-2'>
						<p className='box-text'>Phone number</p>
					</li>
					<li className='mb-4'>
						<p className='box-text'>Usage Data</p>
					</li>
				</ul>
				<h3 className='title-sm text-lg font-medium'>Usage Data</h3>
				<p className='box-text'>
				...
				<ul>
					...
					<li className='mb-2'>
						<p className='box-text'>
							<span className='font-medium'>To manage Your Account:</span> to
					...
					<li className='mb-2'>
						<p className='box-text'>
							<span className='font-medium'>For other purposes:</span> We may
				...
				<h2 className='title-sm'>Disclosure of Your Personal Data</h2>
				<h3 className='title-sm text-lg font-medium'>Business Transactions</h3>
				<p className='box-text'>
				...
				<h3 className='title-sm text-lg font-medium'>Law enforcement</h3>
				<p className='box-text'>
				...
				<ul>
					<li className='mb-2'>
						<p className='box-text'>Comply with a legal obligation</p>
					</li>
					<li className='mb-2'>
						<p className='box-text'>
					...
					<li className='mb-2'>
						<p className='box-text'>Protect against legal liability</p>
					</li>
				</ul>
				<h3 className='title-sm text-lg font-medium'>
			...
			<div className='text-box min-w-xl'>
				...
				<p className='box-text'>
					...
					us By email: aaron@apexapps.com.au
				</p>
			</div>
		</>
	);
