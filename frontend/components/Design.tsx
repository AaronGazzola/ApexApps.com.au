...
const Design = (props: DesignProps) => {
	...
	return (
		<>
			<Keyframes
				name='design1In'
				_0={{ strokeDasharray: 820, strokeDashoffset: 820 }}
				_20={{ strokeDasharray: 820, strokeDashoffset: 820 }}
				_100={{ strokeDasharray: 820, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='design1Out'
				_0={{ strokeDasharray: 820, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 820, strokeDashoffset: 820 }}
			/>
			<Keyframes
				name='design2In'
				_0={{ strokeDasharray: 280, strokeDashoffset: 280 }}
				_25={{ strokeDasharray: 280, strokeDashoffset: 280 }}
			...
			<Keyframes
				...
				_50={{ strokeDasharray: 70, strokeDashoffset: 70 }}
			...
			<Keyframes
				name='design4In'
				_0={{ strokeDasharray: 545, strokeDashoffset: 545 }}
				_60={{ strokeDasharray: 545, strokeDashoffset: 545 }}
				_85={{ strokeDasharray: 545, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='design4Out'
				_0={{ strokeDasharray: 545, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 545, strokeDashoffset: 545 }}
			/>
			<Keyframes
				name='design5In'
				_0={{ strokeDasharray: 120, strokeDashoffset: 120 }}
				_85={{ strokeDasharray: 120, strokeDashoffset: 120 }}
				_100={{ strokeDasharray: 120, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='design5Out'
				_0={{ strokeDasharray: 120, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 120, strokeDashoffset: 120 }}
			/>
			<Keyframes
				name='design6In'
				_0={{ strokeDasharray: 2955, strokeDashoffset: 2955 }}
				_100={{ strokeDasharray: 2955, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='design6Out'
				_0={{ strokeDasharray: 2955, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 2955, strokeDashoffset: 2955 }}
			/>
			...
			>
				<g id='Outline'>
					<path
						style={{
							animation: animate
								? 'design1In 1s linear forwards'
								: 'design1Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'design2In 1s linear forwards'
								: 'design2Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'design3In 1s linear forwards'
								: 'design3Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'design4In 1s linear forwards'
								: 'design4Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'design5In 1s linear forwards'
								: 'design5Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'design6In 1s linear forwards'
								: 'design6Out 1s linear forwards'
						}}
