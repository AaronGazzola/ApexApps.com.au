...
const Deploy = (props: DeployProps) => {
	...
	return (
		<>
			<Keyframes
				name='deploy1In'
				_0={{ strokeDasharray: 2895, strokeDashoffset: 2895 }}
				_100={{ strokeDasharray: 2895, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='deploy1Out'
				_0={{ strokeDasharray: 2895, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 2895, strokeDashoffset: 2895 }}
			/>
			<Keyframes
				name='deploy2In'
				_0={{ strokeDasharray: 930, strokeDashoffset: 930 }}
				_60={{ strokeDasharray: 930, strokeDashoffset: 930 }}
				_80={{ strokeDasharray: 930, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='deploy2Out'
				_0={{ strokeDasharray: 930, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 930, strokeDashoffset: 930 }}
			/>
			<Keyframes
				name='deploy3In'
				_0={{ strokeDasharray: 205, strokeDashoffset: 205 }}
				_85={{ strokeDasharray: 205, strokeDashoffset: 205 }}
				_100={{ strokeDasharray: 205, strokeDashoffset: 0 }}
			/>
			<Keyframes
				name='deploy3Out'
				_0={{ strokeDasharray: 205, strokeDashoffset: 0 }}
				_100={{ strokeDasharray: 205, strokeDashoffset: 205 }}
			/>
			...
			>
				<g>
					<path
						style={{
							animation: animate
								? 'deploy1In 1s linear forwards'
								: 'deploy1Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'deploy2In 1s linear forwards'
								: 'deploy2Out 1s linear forwards'
						}}
					...
					<path
						style={{
							animation: animate
								? 'deploy3In 1s linear forwards'
								: 'deploy3Out 1s linear forwards'
						}}
